...
// 定时器 为保证RunLoop一直运行 定时器里面不要进行操作，否则可能会导致反优化（如果处理了耗时操作，电池电量也会加快）
...
- (void)addRunloopObserver
{
    ...
    /*
     ...
     5 回调： typedef void (*CFRunLoopObserverCallBack)(CFRunLoopObserverRef observer, CFRunLoopActivity activity, void *info);
     6 上下文
     */
    // 创建观察者
